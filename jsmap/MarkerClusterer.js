...
(function(){
     ...
     */
    var getExtendedBounds = function(map, bounds, gridSize,isCluster){
        ...
        if (!isCluster) {
          ...
          ], {strokeColor:`rgb(${Math.random()*100},${Math.random()*30},${Math.random()*50})`, strokeWeight:2, strokeOpacity:0.3,fillOpacity:0,fillColor:''});  //创建矩形
    ...
    Cluster.prototype.updateGridBounds = function() {
        ...
        this._gridBounds = getExtendedBounds(this._map, bounds, this._markerClusterer.getGridSize(),true);
    };
