/* eslint-disable */
import TextIconOverlay from './texticonoverlay';
...
var isTextIconProtoed = false
 var MarkerClusterer = function (map, options) {
   console.log('创建了一个MarkerClusterer')
  try {
    BMap;
  } catch (e) {
 ...
 * @return {Object} 获取vm。
 */
var _vmthisInMarkerCluster = null;
MarkerClusterer.prototype.setVm = function (_vmthis) {
  _vmthisInMarkerCluster = _vmthis;
};
/**
 * 获取vm。
 */
MarkerClusterer.prototype.getVm = function () {
  return _vmthisInMarkerCluster;
};
...
function Cluster(markerClusterer) {
  ...
  this._vmthis = markerClusterer.getVm();
...
Cluster.prototype.updateClusterMarker = function () {
  ...
  this._clusterMarker.addEventListener && !this._clusterMarker._hasClickEvent && this._clusterMarker.addEventListener('click', function (event) {
    if(this._map.getZoom() == 18) return
