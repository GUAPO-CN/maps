import bindEvents from 'vue2-google-maps/dist/utils/bindEvents.js'
import {bindProps, getPropsValues} from 'vue2-google-maps/dist/utils/bindProps.js'
import MapElementMixin from 'vue2-google-maps/dist/components/mapElementMixin'
    ...
    provide () {
      const promise = this.$mapPromise.then((map) => {
        ...
        if (instanceName=='$MarkerObject') {
          console.log(this[instanceName],'this[MarkerObject]');
          console.log(this.$MarkerObject.setLabel,'markerObject');
          // this.$MarkerObject.setLabel = function(labelOptions){
          //   console.log(labelOptions,' lafas eeb暗示法');
